...
class AgentsController:
    ...
    def _try_init_optimized_service(self):
        ...
        try:
            ...
            if optimized_stats_service.check_views_available():
                ...
                logger.info("✓ AgentsController using OPTIMIZED service")
        except:
    ...
    def get_available_agents(self) -> List[dict]:
        ...
        """
        try:
            # Obtener agentes de los �ltimos 7 d�as
    ...
    def get_agent_statistics(self, start_date: str, end_date: str,
        ...
        try:
            ...
            logger.warning("⚠ Using LEGACY service for agents - this may take several minutes with large datasets")
    ...
    def get_realtime_agent_status(self) -> List[dict]:
        ...
        try:
            ...
            # Obtener �ltimo estado de cada agente
            agents_status = {}
            ...
            for record in records:
                ...
                # Actualizar con el evento m�s reciente
